...
package net.abcdroid.devfest12.sync;
...
import net.abcdroid.devfest12.io.AnnouncementsHandler;
import net.abcdroid.devfest12.io.BlocksHandler;
import net.abcdroid.devfest12.io.HandlerException;
import net.abcdroid.devfest12.io.JSONHandler;
import net.abcdroid.devfest12.io.RoomsHandler;
import net.abcdroid.devfest12.io.SandboxHandler;
import net.abcdroid.devfest12.io.SearchSuggestHandler;
import net.abcdroid.devfest12.io.SessionsHandler;
import net.abcdroid.devfest12.io.SpeakersHandler;
import net.abcdroid.devfest12.io.TracksHandler;
import net.abcdroid.devfest12.io.model.EditMyScheduleResponse;
import net.abcdroid.devfest12.io.model.ErrorResponse;
import net.abcdroid.devfest12.provider.ScheduleContract;
import net.abcdroid.devfest12.util.AccountUtils;
...
import static net.abcdroid.devfest12.util.LogUtils.LOGV;
