...
import net.abcdroid.devfest12.io.model.Event;
import net.abcdroid.devfest12.io.model.SessionsResponse;
import net.abcdroid.devfest12.io.model.SessionsResult;
import net.abcdroid.devfest12.provider.ScheduleContract;
import net.abcdroid.devfest12.provider.ScheduleContract.Sessions;
import net.abcdroid.devfest12.provider.ScheduleContract.SyncColumns;
import net.abcdroid.devfest12.util.Lists;
import net.abcdroid.devfest12.util.ParserUtils;

import static net.abcdroid.devfest12.provider.ScheduleDatabase.SessionsSpeakers;
import static net.abcdroid.devfest12.provider.ScheduleDatabase.SessionsTracks;
import static net.abcdroid.devfest12.util.LogUtils.LOGI;
import static net.abcdroid.devfest12.util.LogUtils.LOGW;
import static net.abcdroid.devfest12.util.LogUtils.makeLogTag;
import static net.abcdroid.devfest12.util.ParserUtils.sanitizeId;
